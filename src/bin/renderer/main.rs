...
pub fn example_scene() -> Scene
{
    ...
    let random_function = Vectorize::new(ScalarNoise::new(0, 0.5));
    let test_texture = Lambertian::new(ClosureFunction::new(move |p| random_function.evaluate(p) * 0.5 + 0.5));
    ...
    let transformed = Transformed::new(
        ...
        Textured::new(Plane, test_texture),
